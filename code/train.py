...
parser.add_argument('-genotype_hiddens', help='The number of neurons in each term in genotype parts', type=int, default=6)
parser.add_argument('-drug_hiddens', help='The number of neurons in each layer', type=str, default='100,50,6')
